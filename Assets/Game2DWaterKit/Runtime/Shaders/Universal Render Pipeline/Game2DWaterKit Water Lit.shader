Shader "Game2DWaterKit/Universal Render Pipeline/Lit/Water"
{
	Properties {
	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings vert (Attributes v)
			{
				return Water2D_Vert(v);
			}
			
			half4 frag (Varyings i) : SV_Target
			{
				return Water2D_Frag(i);
			}
	...
	Fallback "Game2DWaterKit/Universal Render Pipeline/Unlit/Water"
